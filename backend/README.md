...
## Project Structure
    ...
    ├── testapiautoteammemb_55762  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_55762`
...
2. Clone this repo and `cd testapiautoteammemb_55762`
